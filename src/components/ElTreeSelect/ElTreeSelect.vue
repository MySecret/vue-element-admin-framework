 ...
 * @LastEditTime: 2021-07-02 16:38:40
 -->
<template>
  <div
  ...
  watch: {
    ...
    labels: function (val) {
      if (!this.collapseTags) {
        let dom = document.getElementsByClassName("el-tree-select-input")[0]
          .firstChild;
        if (val.length > 0) {
          dom.setAttribute("data-line", val.length);
        } else {
          dom.removeAttribute("data-line");
        }
      }
    },
  },
