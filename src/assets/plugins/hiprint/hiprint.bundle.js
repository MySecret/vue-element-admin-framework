    ...
    !function (t) {
        ...
        function o(i) {
            ...
            var element = $(i.data.target),
                ...
                nPageX = i.pageX,
                npageY = i.pageY,
                oPageX = i.data.startX,
                oPageY = i.data.startY,
                diffX = nPageX - oPageX,
                diffY = npageY - oPageY;
            // if (wl + diffX + w > pw || wt + diffY + h >= ph || wl + diffX < 0 || wt + diffY < 0) {
            //     return true;
            // }
            if (wl + diffX + w > pw) {
                i.pageX = pw - wl - w + oPageX;
            }
            if (wt + diffY + h >= ph) {
                i.pageY = ph.wt - h + oPageY;
            }
            if (wl + diffX < 0) {
                i.pageX = -wl + oPageX;
            }
